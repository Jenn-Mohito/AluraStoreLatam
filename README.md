...
Dato Clave: Se observa una brecha de $118 millones entre la Tienda 1 (líder) y la Tienda 4, lo que representa una diferencia crítica en el volumen de captación de capital.

2. Segmentación de Mercado
A través de un mapa de calor, se detectan nichos específicos por sucursal, revelando que cada tienda tiene un público diferenciado.

Dato Clave: Mientras la Tienda 3 domina en mobiliario, la Tienda 4 muestra una especialización notable en artículos educativos y para el hogar.

3. Satisfacción y Preferencias
Se evalúa la calificación promedio de los clientes y los productos con mayor rotación en el inventario.

Dato Clave: La Tienda 3 mantiene el índice de satisfacción más alto (4.05 estrellas), consolidando la mejor reputación de marca dentro del ecosistema.

4. Eficiencia Logística
El estudio del costo de envío revela un hallazgo sorprendente sobre la operatividad de la cadena.

Dato Clave: La Tienda 4 es el referente en eficiencia logística, operando con los costos de distribución más bajos ($23,459) de toda la red.
